...
ALL_CHANNELS = [
    ...
    (11,56),(12,22),(13,33),(14,2),(15,5),(16,48),(17,62),(18,58),(19,49),(20,34),(20,57),
...
DETERMINATIE = {
    1: {'nl':'Smaken (links)', 'en':'Taste (left)',       'type':'actief',
        'desc_nl':'Je eet best één ding tegelijk, bewust en sequentieel. Specifieke smaken en voeding op vaste momenten geven je energie.'},
    2: {'nl':'Smaken (rechts)','en':'Taste (right)',      'type':'passief',
        'desc_nl':'Je gedijt bij variatie en een open tafel. Proef en experimenteer — jouw lichaam weet intuïtief wat het nodig heeft.'},
    3: {'nl':'Geluid (links)', 'en':'Sound (left)',       'type':'actief',
        'desc_nl':'Je hebt een rustige, stille omgeving nodig om goed te eten en te absorberen. Vermijd ruis en afleiding.'},
    4: {'nl':'Geluid (rechts)','en':'Sound (right)',      'type':'passief',
        'desc_nl':'Je gedijt bij levend geluid en gesprek tijdens het eten. Een gezellige, luidruchtige tafel geeft je energie.'},
    5: {'nl':'Indirect licht', 'en':'Indirect Light',    'type':'licht-indirect',
        'desc_nl':'Jouw lichaam reageert op indirect, zacht licht. Eet in gedempte verlichting en vermijd felle, directe lichtbronnen.'},
    6: {'nl':'Direct licht',   'en':'Direct Light',      'type':'licht-direct',
        'desc_nl':'Je hebt direct zonlicht of heldere verlichting nodig. Eet bij voorkeur buiten of in een lichte, zonnige ruimte.'},
}

OMGEVING = {
    1: {'nl':'Selectieve grotten',    'en':'Selective Caves','type':'selectief',
...
PERSPECTIEF = {
    ...
    4: {'nl':'Mogelijkheid (opportunist)', 'en':'Possibility (Opportunist)','type':'mogelijkheid',
        'desc_nl':'Je ziet mogelijkheden en kansen overal. Jouw perspectief is strategisch en optimistisch gericht.'},
